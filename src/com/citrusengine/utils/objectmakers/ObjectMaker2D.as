package com.citrusengine.utils.objectmakers {
	...
	public class ObjectMaker2D {
		 ...
		 * 
		 */
		public static function FromGleed(levelXML:XML, addToCurrentState:Boolean = true, layerIndexProperty:String = "group", defaultClassName:String = "com.citrusengine.objects.CitrusSprite"):Array {
