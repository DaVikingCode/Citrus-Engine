	...
	public class StarlingArt extends Sprite implements ICitrusArt {
				...
				if (_view is String) {
					...
					// view property is a fully qualified class name in string form. 
						...
						if (tmpObj is flash.display.MovieClip) {
							...
							_content = new Image(_texture = Texture.fromBitmap(tmpObj, false, true, _ce.scaleFactor));
						}
						else if (tmpObj is BitmapData) {
							_content = new Image(_texture = Texture.fromBitmapData(tmpObj, false, true, _ce.scaleFactor));
						}
					...
					_content = new Image(_texture = Texture.fromBitmap(_view, false, true, _ce.scaleFactor));
		...
		private function handleContentLoaded(evt:Event):void {
			...
			if (evt.target.loader.content is flash.display.MovieClip)
				...
				_content = new Image(_texture = Texture.fromBitmap(evt.target.loader.content, false, true, _ce.scaleFactor));
