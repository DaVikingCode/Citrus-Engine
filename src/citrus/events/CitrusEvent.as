package citrus.events 
{
	public class CitrusEvent 
	{
		...
		internal var _useCapture:Boolean = false;
		...
		public function CitrusEvent(type:String, bubbles:Boolean = true, cancelable:Boolean = false, useCapture:Boolean = false) 
		{
			_type = type;
			_bubbles = bubbles;
		...
		{
			return "[CitrusEvent type:" + _type + " target:" + Object(_target).constructor +" currentTarget:"+ Object(_currentTarget).constructor +" bubbles:" + _bubbles +" cancelable:" + _cancelable + " useCapture:" + _useCapture + " ]";
		}
