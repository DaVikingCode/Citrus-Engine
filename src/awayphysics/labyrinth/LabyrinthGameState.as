package awayphysics.labyrinth {
	 ...
	 * @author Aymeric
	 */
	public class LabyrinthGameState extends State {
		
		[Embed(source="/../embed/3D/labyrinth.away3d4", mimeType="application/octet-stream")]
		private const _LABYRINTH_LEVEL:Class;
		...
		public function LabyrinthGameState() {
		...
		override public function initialize():void {
			...
			ObjectMaker3D.FromCadetEditor3D(XML(new _LABYRINTH_LEVEL()));
